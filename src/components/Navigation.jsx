  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-between items-end mb-1 relative z-10">
        <span
          className={`font-mono text-[9px] tracking-widest transition-colors duration-300 ${active ? colorClass : "text-green-900/60 group-hover:text-white"}`}
        >
          [{id}]
        </span>
      ...
      <div className="flex w-full items-center gap-3 relative z-10">
        ...
        <div
          className={`transition-all duration-300 ${bgClass} ${
            active
              ? "w-1 h-8 opacity-100 shadow-[0_0_8px_currentColor]"
              : isHovered
                ? "w-0.5 h-6 opacity-80"
                : "w-[1px] h-4 opacity-30"
          }`}
        />
        ...
        <div className="flex flex-col flex-1">
          ...
          {/* Secondary Sub-Label */}
          <span
            className={`font-mono text-[8px] tracking-[0.2em] transition-all duration-300 ${active ? colorClass : "text-green-900/40 group-hover:text-green-500/80"}`}
          >
            {subLabel}
          </span>
        </div>
  ...
  return (
    <>
      ...
      <nav
        ...
        style={{
          boxShadow:
            "inset 40px 0 100px rgba(0, 200, 255, 0.05), -5px 0 30px rgba(0, 255, 100, 0.1)",
        }}
      >
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, transparent, rgba(0,255,200,0.1), transparent)",
          ...
          <div
            ...
            style={{ animation: "hologram-flicker 0.15s steps(3) infinite" }}
          />
